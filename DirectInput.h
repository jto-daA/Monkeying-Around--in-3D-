...
/* Ripped from dinput.h for easy referencing
/****************************************************************************
 *
...
extern m_byte keyBoard[ 256 ];

#define DI_KEYDOWN(key) ((keyBoard[ key ] & 0x80) ? m_true : m_false)
#define DI_KEYUP(key)   ((keyBoard[ key ] & 0x80) ? m_false : m_true)
